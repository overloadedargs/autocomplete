  ...
  (0, _createClass2["default"])(RecipeClient, [{
    ...
    value: function search(_ref2) {
      var _ref2$query = _ref2.query,
          query = _ref2$query === void 0 ? null : _ref2$query,
          _ref2$recipeId = _ref2.recipeId,
          recipeId = _ref2$recipeId === void 0 ? null : _ref2$recipeId,
          _ref2$limit = _ref2.limit,
          limit = _ref2$limit === void 0 ? {
        from: 0,
        to: 30
      } : _ref2$limit,
          _ref2$maxIngredients = _ref2.maxIngredients,
          maxIngredients = _ref2$maxIngredients === void 0 ? null : _ref2$maxIngredients,
          _ref2$mealType = _ref2.mealType,
          mealType = _ref2$mealType === void 0 ? null : _ref2$mealType,
          _ref2$calories = _ref2.calories,
          calories = _ref2$calories === void 0 ? null : _ref2$calories,
          _ref2$time = _ref2.time,
          time = _ref2$time === void 0 ? null : _ref2$time,
          _ref2$dietLabels = _ref2.dietLabels,
          dietLabels = _ref2$dietLabels === void 0 ? [] : _ref2$dietLabels,
          _ref2$healthLabels = _ref2.healthLabels,
          healthLabels = _ref2$healthLabels === void 0 ? [] : _ref2$healthLabels,
          _ref2$cuisineTypeLabe = _ref2.cuisineTypeLabels,
          cuisineTypeLabels = _ref2$cuisineTypeLabe === void 0 ? [] : _ref2$cuisineTypeLabe,
          _ref2$dishTypeLabels = _ref2.dishTypeLabels,
          dishTypeLabels = _ref2$dishTypeLabels === void 0 ? [] : _ref2$dishTypeLabels,
          _ref2$excludedIngredi = _ref2.excludedIngredients,
          excludedIngredients = _ref2$excludedIngredi === void 0 ? [] : _ref2$excludedIngredi;
      var params = [['q', query], ['r', recipeId], ['from', limit.from], ['to', limit.to], ['ingr', maxIngredients], ['mealType', mealType], ['calories', calories], ['time', time]].concat((0, _toConsumableArray2["default"])(dietLabels.map(function (dl) {
        return ['diet', dl];
      })), (0, _toConsumableArray2["default"])(healthLabels.map(function (hl) {
        return ['health', hl];
      })), (0, _toConsumableArray2["default"])(cuisineTypeLabels.map(function (ctl) {
        return ['cuisineType', ctl];
      })), (0, _toConsumableArray2["default"])(dishTypeLabels.map(function (dtl) {
        return ['dishType', dtl];
      })), (0, _toConsumableArray2["default"])(excludedIngredients.map(function (ei) {
        return ['excluded', ei];
      }))).map(function (_ref3) {
        ...
        return [null, undefined].includes(value) ? null : "".concat(key, "=").concat(encodeURIComponent(value));
      }).filter(function (x) {
        return x;
      }).join('&');
      return this.get("*search?".concat(params), {});
    }
  }]);
  return RecipeClient;
}();
